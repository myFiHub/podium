...
/// Proxy class for `copyWith` functionality. This is a callable class and can be used as follows: `instanceOfLiveMember.copyWith(...)`. Additionally contains functions for specific fields e.g. `instanceOfLiveMember.copyWith.fieldName(...)`
class _$LiveMemberCWProxyImpl implements _$LiveMemberCWProxy {
  ...
  @override
  LiveMember address(String address) => this(address: address);
  ...
  @override
  LiveMember is_present(bool is_present) => this(is_present: is_present);
  ...
  @override
  LiveMember uuid(String uuid) => this(uuid: uuid);

  @override
  LiveMember last_speaked_at_timestamp(int? last_speaked_at_timestamp) =>
      this(last_speaked_at_timestamp: last_speaked_at_timestamp);
  ...
  LiveMember call({
    ...
    return LiveMember(
      address: address == const $CopyWithPlaceholder()
          ...
          : address as String,
      can_speak: can_speak == const $CopyWithPlaceholder()
          ? _value.can_speak
          // ignore: cast_nullable_to_non_nullable
          : can_speak as bool,
      ...
      image: image == const $CopyWithPlaceholder()
          ...
          // ignore: cast_nullable_to_non_nullable
          : image as String,
      is_present: is_present == const $CopyWithPlaceholder()
          ? _value.is_present
          // ignore: cast_nullable_to_non_nullable
          : is_present as bool,
      is_speaking: is_speaking == const $CopyWithPlaceholder()
          ? _value.is_speaking
          // ignore: cast_nullable_to_non_nullable
          : is_speaking as bool,
...
extension $LiveMemberCopyWith on LiveMember {
  /// Returns a callable class that can be used as follows: `instanceOfLiveMember.copyWith(...)` or like so:`instanceOfLiveMember.copyWith.fieldName(...)`.
