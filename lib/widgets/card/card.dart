...
import 'package:podium/widgets/buttonBar/buttonBar.dart';
import 'package:podium/widgets/imageOverlay/imageOverlay.dart';
...
class Card extends StatelessWidget {
  ...
  /// [Position] titlePosition helps to set titlebar at top of card
  ...
  /// overlay image [ImageOverlay] widget can be used
  ...
  final PodiumButtonBar? buttonBar;

  /// How the image should be inscribed into the box.
  /// The default is [BoxFit.scaleDown] if centerSlice is null, and
  /// [BoxFit.fill] if centerSlice is not null.
  /// [boxFit] for only [ImageOverlay]
  final BoxFit? boxFit;

  /// A color filter to apply to the image before painting it.
  final ColorFilter? colorFilter;

  /// The corners of this [Card] are rounded by this [BorderRadius].
  ...
  Widget build(BuildContext context) {
    ...
    final Widget overlayImage = ImageOverlay(
